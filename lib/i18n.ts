...
const en: Dict = {
  ...
  "search.placeholder": "Search by address, neighborhood, or ZIP",
  "search.clear": "Clear search",
  "controls.scope.search": "matching “{q}”",
  "search.emptyTitle": "No listings match your search",
  "search.emptyBody": "Try a different address, area, or ZIP. This demo covers 50 curated Austin listings.",
...
const es: Dict = {
  ...
  "search.placeholder": "Busca por dirección, zona o código postal",
  "search.clear": "Borrar búsqueda",
  "controls.scope.search": "que coinciden con “{q}”",
  "search.emptyTitle": "Ninguna propiedad coincide con tu búsqueda",
  "search.emptyBody": "Prueba otra dirección, zona o código postal. Esta demo cubre 50 propiedades seleccionadas de Austin.",
